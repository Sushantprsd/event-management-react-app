...
class Signup extends Component {
    ...
    submitHandler = (e) => {
        e.preventDefault();
        this.props.authSubmitHandler(
            this.state.inputForm.email.value,
            this.state.inputForm.password.value,
            this.state.inputForm.name.value,
        );
    };
    ...
    render() {
        ...
        let button = (
            <div className={classes.FormSubmit}>
                ...
                <span className={classes.SignUp} onClick={this.RedirectLogin}>
        ...
        let form = (
            <form className={classes.InputForm}>
                ...
                <span className={classes.ErrorSpan}>{this.props.auth.signUpError ? this.props.auth.signUpError : null}</span>
                {button}
            </form>
        );
...
const mapDispatchToProps = (dispatch) => {
    return {
        authSubmitHandler: (email, password, name) => dispatch(actions.authSignUp(email, password, name)),
    };
};
